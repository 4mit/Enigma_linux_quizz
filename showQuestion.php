				   ...
				   <h4 align="center">'. $q['question'].'</h4>
					...
					<p id="options">
					  <form id="question_form">
					   ...
					   <button type="button" id="save_answer"  name="save_answer" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="I\'m Done Now ">Finish The Game</button>                                       
					 </form>
					</p>
				</div>
			  </div>';
